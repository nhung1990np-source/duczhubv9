...
" or v450.Name == "Cookie Crafter"))) and v450.Humanoid.Health > 0 then
                                repeat
                                    ...
                                    AttackNoCoolDown()
                                until _G.Cake == false or (game:GetService("ReplicatedStorage"):FindFirstChild("Calocal vu1 = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
                ...
                pcall(function()
                    ...
                    elseif game.Workspace.Enemies:FindFirstChild("Baking Staff") or (game.Workspace.Enemies:FindFirstChild("Head Baker") or (game.Workspace.Enemies:FindFirstChild("Cake Guard") or game.Workspace.Enemies:FindFirstChild("Cookie Crafter"))) then
                        ...
                        while true do
                            ...
                            if (v450.Name == "Baking Staff" or (v450.Name == "Head Baker" or (v450.Name == "Cake Guardke Prince") or (game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") or (not v450.Parent or v450.Humanoid.Health <= 0)))
                            end
                        end
                    else
                        bringmob = false
